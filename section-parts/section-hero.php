	...
	?> data-images="<?php echo esc_attr( json_encode( $images ) ); ?>"<?php } ?>
		...
		switch ( $layout ) {
			...
			default:
				...
				<!--ADDED-->
				<?php echo apply_shortcodes( '[contact-form-7 id="2545" title="Buy Back Front Page"]' ); ?>
				
					<!-- <div class="fieldset-wrapper">
						<input type="text" 
						name="postalCode" 
						id="estimate_step1_postal" 
						pattern="^[A-Za-z]\d[A-Za-z][ -]?\d[A-Za-z]\d$" 
						inputmode="numeric" 
						data-parsley-pattern-message="Please enter your postal code." 
						title="Enter a valid postal code" 
						placeholder="Enter your postal code" size="8" required="" 
						data-parsley-id="69" class="parsley-success">
						<button type="submit" class="btn btn-primary btn-primary--estimate">Get Estimate</button>
					</div> -->
